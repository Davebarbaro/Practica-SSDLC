...
function getApiUrl(path) {
    // Usar !== undefined para permitir cadenas vacías (para rutas relativas)
    const baseUrl = (typeof window.API_BASE_URL !== 'undefined') ? window.API_BASE_URL : 'http://localhost:8000';
    return baseUrl + path;
}
